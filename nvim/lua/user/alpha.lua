...
dashboard.section.buttons.val = {
	...
	dashboard.button("l", "󰁯  Restore last session", ":lua require(\"persistence\").load({ last = true })<BAR> cd %:p:h <CR>"),
	dashboard.button("c", "  Configuration", ":e ~/.config/nvim/init.lua <BAR> cd %:p:h <CR>"),
